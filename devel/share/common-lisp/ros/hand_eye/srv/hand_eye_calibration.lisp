...
(cl:defmethod cl:initialize-instance :after ((m <hand_eye_calibration-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hand_eye_calibration-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_eye-srv:<hand_eye_calibration-request> is deprecated: use hand_eye-srv:hand_eye_calibration-request instead.")))
...
(cl:defmethod end_trans-val ((m <hand_eye_calibration-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:end_trans-val is deprecated.  Use hand_eye-srv:end_trans instead.")
  (end_trans m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<hand_eye_calibration-request>)))
  ...
  "hand_eye/hand_eye_calibrationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'hand_eye_calibration-request)))
  "Returns string type for a service object of type 'hand_eye_calibration-request"
  "hand_eye/hand_eye_calibrationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <hand_eye_calibration-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'hand_eye_calibration-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_eye-srv:<hand_eye_calibration-response> is deprecated: use hand_eye-srv:hand_eye_calibration-response instead.")))

(cl:ensure-generic-function 'is_done-val :lambda-list '(m))
(cl:defmethod is_done-val ((m <hand_eye_calibration-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:is_done-val is deprecated.  Use hand_eye-srv:is_done instead.")
  (is_done m))

(cl:ensure-generic-function 'end2cam_trans-val :lambda-list '(m))
(cl:defmethod end2cam_trans-val ((m <hand_eye_calibration-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:end2cam_trans-val is deprecated.  Use hand_eye-srv:end2cam_trans instead.")
  (end2cam_trans m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<hand_eye_calibration-response>)))
  ...
  "hand_eye/hand_eye_calibrationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'hand_eye_calibration-response)))
  "Returns string type for a service object of type 'hand_eye_calibration-response"
  "hand_eye/hand_eye_calibrationResponse")
