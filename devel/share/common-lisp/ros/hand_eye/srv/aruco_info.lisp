...
(cl:defmethod cl:initialize-instance :after ((m <aruco_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'aruco_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_eye-srv:<aruco_info-request> is deprecated: use hand_eye-srv:aruco_info-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <aruco_info-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:cmd-val is deprecated.  Use hand_eye-srv:cmd instead.")
  (cmd m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <aruco_info-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:id-val is deprecated.  Use hand_eye-srv:id instead.")
  (id m))
...
(cl:defmethod cl:initialize-instance :after ((m <aruco_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'aruco_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hand_eye-srv:<aruco_info-response> is deprecated: use hand_eye-srv:aruco_info-response instead.")))

(cl:ensure-generic-function 'ids-val :lambda-list '(m))
(cl:defmethod ids-val ((m <aruco_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:ids-val is deprecated.  Use hand_eye-srv:ids instead.")
  (ids m))

(cl:ensure-generic-function 'tvecs-val :lambda-list '(m))
(cl:defmethod tvecs-val ((m <aruco_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:tvecs-val is deprecated.  Use hand_eye-srv:tvecs instead.")
  (tvecs m))

(cl:ensure-generic-function 'rvecs-val :lambda-list '(m))
(cl:defmethod rvecs-val ((m <aruco_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hand_eye-srv:rvecs-val is deprecated.  Use hand_eye-srv:rvecs instead.")
  (rvecs m))
